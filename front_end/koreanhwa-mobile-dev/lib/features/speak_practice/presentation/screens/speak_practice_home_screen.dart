      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SpeakStatsRow(stats: SpeakPracticeMockData.stats),
            const SizedBox(height: 24),
            const SectionTitle(title: 'Nhiệm vụ hôm nay'),
            const SizedBox(height: 12),
            ...SpeakPracticeMockData.missions.map((mission) => SpeakMissionCard(mission: mission)),
            const SizedBox(height: 24),
            ...
            const SizedBox(height: 24),
            const SectionTitle(title: 'Huấn luyện viên nổi bật'),
            const SizedBox(height: 12),
            const CoachCard(),
          ],
        ),
