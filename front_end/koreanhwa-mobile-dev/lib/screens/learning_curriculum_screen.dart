...
class _LearningCurriculumScreenState extends State<LearningCurriculumScreen> {
    ...
    'grammar': [
      {
        ...
        'explanation':
            '안녕하세요 được sử dụng để chào hỏi một cách lịch sự',
        'examples': [
  ...
  final tabs = [
    {'id': 'video', 'name': 'Video', 'icon': Icons.video_library},
    ...
    {'id': 'ai-chat', 'name': 'AI Chat', 'icon': Icons.chat},
  ];
  ...
  Widget _buildGrammarTab() {
    final grammar = lessonData['grammar'] as List;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                ...(item['examples'] as List).map((example) {
                  return Container(
  ...
  Widget _buildExerciseTab() {
    final exercises = lessonData['exercises'] as List;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    'Câu ${exercises.indexOf(exercise) + 1}: ${exercise['question']}',
                    style: const TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.bold,
                      color: AppColors.primaryBlack,
